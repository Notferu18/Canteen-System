                        ...
                        {cart.map(item => (
                            <div key={item.id} className={s.manifestItem}>
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-2 mt-2">
                                        <button
                                            ...
                                            className="w-5 h-5 bg-zinc-800 hover:bg-zinc-700 text-white text-xs font-black rounded-sm flex items-center justify-center transition"
                                        >
                                            −
                                        </button>
                                ...
                                <div className="flex items-center gap-4">
                                    <span className="text-sm font-black text-[#FF2D20]">
